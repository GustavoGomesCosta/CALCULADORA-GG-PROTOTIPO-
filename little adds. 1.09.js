let opçao = Infinity
while(opçao!= 0){opçao = (prompt("oq deseja fazer?(0)fechar (1)soma (2)menos (3)vezes (4)divisao (5)media (6)impar/par (7)porcentagem (8)achar porcentagem (9)tabuada (10)potencia"))
let resultado = 0
...
if(opçao == 6){
   resultado = imparoupar()
   console.log("impar = false / par = true")
...
function porcentagem1 (){
    ...
    let porcentagem = Number(prompt("insira a porcentage que deseja retirar: "))
     let porcentagemfinal = (numero * porcentagem) / 100
